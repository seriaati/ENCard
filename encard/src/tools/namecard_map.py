...
async def update_namecard(character_id):
   async with aiohttp.ClientSession() as session:
        async with session.get(f"https://gi.yatta.top/api/v2/ru/avatar/{character_id}") as response:
      ...
      if self.charter_id  in mapping:
            ...
            if data["data"]["other"] is None:
               mapping[self.charter_id] = {
                  "id": 210192,
                  "icon": f"https://gi.yatta.top/api/assets/UI/namecard/UI_NameCardPic_OST4_P.png",
                  "image": f"https://gi.yatta.top/api/assets/UI/namecard/UI_NameCardPic_OST4_P.png"
               }
            else:
               ...
               mapping[self.charter_id] = {
                  ...
                  "icon": f"https://gi.yatta.top/api/assets/UI/namecard/{name_card_icon}.png",
                  "image": f"https://gi.yatta.top/api/assets/UI/namecard/{name_card_icon_image}_P.png"
               }
